...
string Exp::binopToString(BinaryOp op) {
  ...
  case LTEQ: return "<=";
  case EQ: return "==";
  case AND: return "and"; // Add (2)
  case OR: return "or"; // Add (2)
  }
  return "";
}
...
BoolExp::BoolExp(bool v):value(v) {} // Add (1)
...
ForDoStatement::ForDoStatement(Exp* e1, Exp* e2, Body* b):e1(e1),e2(e2),body(b) { } // Add (3)
...
ForDoStatement::~ForDoStatement() { delete e1; delete e2; delete body; } // Add (3)
...
/* Add (3) */
int ForDoStatement::accept(ImpVisitor* v) {
  return v->visit(this);
}
/* ----- */
